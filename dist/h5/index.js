...
function _AddressPicker(props, ref) {
    ...
    var _a = __read(react.exports.useState([]), 2), _options = _a[0], setOptions = _a[1];
    var _b = __read(react.exports.useState([]), 2), selected = _b[0], setSelected = _b[1];
...
var AddressPicker = react.exports.forwardRef(_AddressPicker);
var defaultProps = {
    title: '请选择地址',
    isOpened: false,
    options: [],
